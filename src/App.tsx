      ...
      <div className="mx-auto grid max-w-6xl gap-8 px-4 md:grid-cols-4 md:px-6">
        ...
        <div>
          ...
          <div className="mt-5 flex gap-3 text-[#D4AF37]">
            ...
            <a href="https://facebook.com" aria-label="Facebook" className="inline-flex h-8 w-8 items-center justify-center border border-[#D4AF37]/60 text-xs font-semibold">
              FB
            </a>
            <a href="https://linkedin.com" aria-label="LinkedIn" className="inline-flex h-8 w-8 items-center justify-center border border-[#D4AF37]/60">
              <Handshake size={18} />
            </a>
            <a href="https://digizinc.com" aria-label="Website" className="inline-flex h-8 w-8 items-center justify-center border border-[#D4AF37]/60">
              <Globe size={18} />
            </a>
          </div>
        </div>
