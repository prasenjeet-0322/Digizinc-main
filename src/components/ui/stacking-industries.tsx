                  ...
                  {industries.map((industry, i) => (
                    ...
                    >
                      <motion.article
                        ...
                        className="relative flex flex-col h-full w-full max-w-[500px] rounded-[2rem] border-0 md:border md:border-white/10 bg-[#0a0a0a] shadow-2xl overflow-hidden group hover:border-[#F23030]/50 transition-colors duration-500 touch-auto"
                      >
